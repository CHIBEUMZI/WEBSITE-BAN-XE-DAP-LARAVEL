...
<body class="bg-gray-50 text-gray-800 min-h-screen flex flex-col">
  ...
  <main class="container mx-auto px-4 py-8 flex-grow">
    <h2 class="text-3xl font-semibold text-blue-700 mb-6 border-b-2 border-blue-400 pb-2">Chi tiết yêu cầu bảo trì</h2>
    ...
    {{-- Nếu bạn muốn nút quay lại, có thể mở phần này --}}
    {{-- <div class="max-w-3xl mx-auto mt-6">
      <a href="{{ route('client.maintenance.index') }}" class="inline-block bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded transition">
        Quay lại danh sách
      </a>
    </div> --}}
  </main>
